"""
Incremental Pull Request Merged ingestion
(primary-signal only, append-safe)
"""
...
# - merged_at and merge_commit_sha are authoritative
# - updated_at allows incremental scanning
...
if __name__ == "__main__":
    ...
    print("-----------------------------------")
    print(f"New PR_MERGED events: {len(new_records)}")
